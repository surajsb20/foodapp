...
public class OrderDetailAdapter extends RecyclerView.Adapter<OrderDetailAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        float priceAmount = item.getProduct().getPrices().getPrice()*item.getQuantity();
        ...
        holder.price.setText(item.getProduct().getPrices().getCurrency() + Utils.formatPreciseFloat(priceAmount));
