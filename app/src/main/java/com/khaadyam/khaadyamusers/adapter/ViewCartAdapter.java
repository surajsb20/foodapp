...
import com.khaadyam.khaadyamusers.fragments.CartChoiceModeFragment;
import com.khaadyam.khaadyamusers.fragments.CartFragment;
import com.khaadyam.khaadyamusers.fragments.AddonBottomSheetFragment;
...
public class ViewCartAdapter extends RecyclerView.Adapter<ViewCartAdapter.MyViewHolder> {
    ...
    private static SharedPrefrences sharedPrefrences;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.priceTxt.setText(product.getPrices().getCurrency() + " " + Utils.formatPreciseDouble(priceAmount));
            ...
            public void onResponse(Call<AddCart> call, Response<AddCart> response) {
                ...
                if (response != null && !response.isSuccessful() && response.errorBody() != null) {
                    ...
                    if (itemCount != 0) {
                        ...
                        CartFragment.itemTotalAmount.setText(currency + "" + Utils.formatPreciseDouble(priceAmount));
                        ...
                        CartFragment.payAmount.setText(currency + "" + Utils.formatPreciseDouble(topPayAmount));
