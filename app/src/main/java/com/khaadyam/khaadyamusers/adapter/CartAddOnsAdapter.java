...
public class CartAddOnsAdapter extends RecyclerView.Adapter<CartAddOnsAdapter.MyViewHolder> {
    ...
    private void setAddOnsText() {
        ...
        if (AddonBottomSheetFragment.selectedCart != null) {
            ...
            if (quantity == 1)
                AddonBottomSheetFragment.price.setText(String.valueOf(quantity) + " Item | " + GlobalData.currencySymbol + Utils.formatPreciseDouble(priceAmount));
            else
                AddonBottomSheetFragment.price.setText(String.valueOf(quantity) + " Items | " + GlobalData.currencySymbol + Utils.formatPreciseDouble(priceAmount));
