...
import com.khaadyam.khaadyamusers.fragments.HomeFragment;
import com.khaadyam.khaadyamusers.fragments.ProfileFragment;
import com.khaadyam.khaadyamusers.fragments.SearchFragment;
...
import static com.khaadyam.khaadyamusers.helper.GlobalData.disputeMessageList;
import static com.khaadyam.khaadyamusers.helper.GlobalData.notificationCount;
import static com.khaadyam.khaadyamusers.helper.GlobalData.profileModel;
                ...
                switch (position) {
                    case 0:
                        if (GlobalData.profileModel == null) {
                            ...
                            startActivity(new Intent(HomeActivity.this, Meal1.class));
                            overridePendingTransition(R.anim.anim_push_left_in, R.anim.anim_nothing);
                        }
                        break;
                    case 1:
...
//        final LocationSettingsStates states = LocationSettingsStates.fromIntent(data);
    ...
    public static void updateNotificationCount(Context context, int itemCount) {
        if (itemCount == 0) {
            ...
            bottomNavigation.setNotification(String.valueOf(itemCount), 3);
        }
