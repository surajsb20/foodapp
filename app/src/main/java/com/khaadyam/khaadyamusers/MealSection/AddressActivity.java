...
public class AddressActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.khaadyam.khaadyamusers.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = com.khaadyam.khaadyamusers.MealSection.AddressActivity.this;
        address = new com.khaadyam.khaadyamusers.models.Address();
...
//            getAddress(context, srcLat, srcLng);
    ...
    private void saveAddress() {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            Call<com.khaadyam.khaadyamusers.models.Address> call = apiInterface.saveAddress(address);
            call.enqueue(new Callback<com.khaadyam.khaadyamusers.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.khaadyam.khaadyamusers.models.Address> call, @NonNull Response<com.khaadyam.khaadyamusers.models.Address> response) {
                    ...
                    if (response.isSuccessful()) {
                        if (isAddressSave) {
                            ...
                            startActivity(new Intent(context, Meals4.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                            finish();
                        } else {
                            GlobalData.selectedAddress = response.body();
                            GlobalData.addressList.getAddresses().add(response.body());
                        ...
                        if(error.getType()!= null && error.getType().size()> 0){
                            ...
                            startActivity(new Intent(context, Meals4.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                            finish();
//                            Toast.makeText(AddressActivity.this, error.getType().get(0), Toast.LENGTH_SHORT).show();
                        }
                    }
                }

                @Override
                public void onFailure(@NonNull Call<com.khaadyam.khaadyamusers.models.Address> call, @NonNull Throwable t) {
...
//                    Toast.makeText(AddressActivity.this, "Something went wrong", Toast.LENGTH_LONG).show();
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.khaadyam.khaadyamusers.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.khaadyam.khaadyamusers.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.khaadyam.khaadyamusers.models.Address> call, @NonNull Response<com.khaadyam.khaadyamusers.models.Address> response) {
                    customDialog.dismiss();
        ...
        switch (view.getId()) {
            ...
            case R.id.save:
                ...
                if (address.getBuilding().equalsIgnoreCase("")) {
                    ...
                    sharedPrefrences.setTvAddress(addressEdit.getText().toString() + " , "+flatNoEdit.getText().toString()+" , "+landmark.getText().toString());
                    }
                }
                break;
            case R.id.skip_txt:
