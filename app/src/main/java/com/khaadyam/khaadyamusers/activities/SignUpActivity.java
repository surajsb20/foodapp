...
import com.khaadyam.khaadyamusers.CountryPicker.Country;
import com.khaadyam.khaadyamusers.CountryPicker.CountryPicker;
import com.khaadyam.khaadyamusers.CountryPicker.CountryPickerListener;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        termsText.setText(
                Html.fromHtml(
                        "I agree to " +
                                "<a href=\"https://daynightfoods.ca/terms\">terms and conditions.</a> "));
...
//                FirebaseAuth.getInstance().signOut();
    ...
    public void initValues() {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            Toast.makeText(this, "Need to accept terms and conditions.", Toast.LENGTH_SHORT).show();
    ...
    public void getOtpVerification(HashMap<String, String> map) {
        ...
        call.enqueue(new Callback<Otp>() {
            ...
            public void onResponse(@NonNull Call<Otp> call, @NonNull Response<Otp> response) {
                ...
                Log.d("ERRORC", "OTP verification response = " + response.body().toString());
