...
//                Log.d("ERRORC", "OTP verification response = " + response.body().toString());
            ...
            public void onFailure(@NonNull Call<Otp> call, @NonNull Throwable t) {
                Log.d("ERRORC", "OTP verification response error = " + t.getMessage());
                customDialog.dismiss();
...
//                Snackbar.make(this.findViewById(android.R.id.content), getResources().getString(R.string.coming_soon), Snackbar.LENGTH_SHORT).show();
            ...
            case R.id.next_btn:
                ...
                if (helper.isConnectingToInternet()) {
                    ...
                    Utils.displayMessage(MobileNumberActivity.this, context, getString(R.string.oops_connect_your_internet));
