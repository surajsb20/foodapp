...
//                        }
    ...
    public void addBmboraCardToAccount(final Card card) {

        HashMap<String, String> params = new HashMap<>();
        params.put("payment_mode", "bambora");
        params.put("bambora", "bambora");
        ...
        Call<Message> call = apiInterface.addCardBambora(params);
