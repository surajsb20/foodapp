...
import com.khaadyam.khaadyamusers.adapter.AccountPaymentAdapter;
...
import static com.khaadyam.khaadyamusers.helper.GlobalData.cardArrayList;
import static com.khaadyam.khaadyamusers.helper.GlobalData.currencySymbol;
import static com.khaadyam.khaadyamusers.helper.GlobalData.isCardChecked;
...
//        }
    ...
    private void checkOut(HashMap<String, String> map) {
        ...
        Log.d("Pay = ", call.request().body().toString());
