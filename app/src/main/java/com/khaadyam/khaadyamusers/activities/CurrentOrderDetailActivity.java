...
import com.khaadyam.khaadyamusers.adapter.OrderFlowAdapter;
import com.khaadyam.khaadyamusers.build.api.ApiClient;
import com.khaadyam.khaadyamusers.build.api.ApiInterface;
import com.khaadyam.khaadyamusers.fragments.OrderViewFragment;
import com.khaadyam.khaadyamusers.helper.CustomDialog;
import com.khaadyam.khaadyamusers.helper.DataParser;
...
import com.khaadyam.khaadyamusers.models.OrderFlow;
...
import static com.khaadyam.khaadyamusers.helper.GlobalData.ORDER_STATUS;
import static com.khaadyam.khaadyamusers.helper.GlobalData.isSelectedOrder;
...
public class CurrentOrderDetailActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener,
    ...
    private ArrayList<OrderFlow> orderFlowList;
...
//        sendPushNotification(map);
        ...
        orderFlowList = new ArrayList<>();
//        setupOrderFlowList(false);
        ...
        call.enqueue(new Callback<Order>() {
            ...
            public void onResponse(@NonNull Call<Order> call, @NonNull Response<Order> response) {
                if (response.isSuccessful()) {
                    ...
                    if (isSelectedOrder.getPickup() == 1) {
                        setupOrderFlowList(true);
                    } else {
                        setupOrderFlowList(false);
                    }
    ...
    private void setupOrderFlowList(boolean isSelfPickup) {
        ...
        if (isSelfPickup) {
            orderFlowList.add(new OrderFlow(getString(R.string.order_pickedup), getString(R.string.description_4_2), R.drawable.ic_order_picked_up, ORDER_STATUS.get(5) + ORDER_STATUS.get(6)));
        } else {
